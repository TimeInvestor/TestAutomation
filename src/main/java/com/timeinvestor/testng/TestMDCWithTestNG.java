 ...
 * @Since Sep 15, 2015
 */
public class TestMDCWithTestNG extends TestBase {
    
    public TestMDCWithTestNG() {
        super(TestMDCWithTestNG.class);
    }
    ...
    private void beforeEachTestCase(Object[] testData) {
        ...
        ThreadContext.put("testClass", TestMDCWithTestNG.class.getSimpleName());
    ...
    private void afterEachTestCase(Object[] testData) {
        logger.info("Finished test case: " + testData[0] + " - " + testData[1]);
    ...
    private void testMethod1(String testCaseId, Integer age) {
        ...
        TestHelper.prettyPrint(logger, "TestMDCWithTestNG - testMethod1 - prettyPrint - testCaseId: " + testCaseId);
    }
    ...
    private void testMethod2(String testCaseId, Integer age) {
        ...
        TestHelper.prettyPrint(logger, "TestMDCWithTestNG - testMethod2 - prettyPrint - testCaseId: " + testCaseId);
    }
